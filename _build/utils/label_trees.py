...
func=/(nmod|obl):unmarked/&lemma=/^([0-9]{1,4}|[12]?[0-9]:[0-5][0-9]|30th|a\.m\.|AD|afternoon|April|August|autumn|century|couple|day|decade|EDT|evening|fall|February|five|Friday|GMT|hour|hundred|January|June|length|life|little|lot|March|matter|May|minute|moment|Monday|month|morning|most|next|night|oclock|October|p\.m\.|period|quarter|rest|Saturday|season|second|September|spring|Su|summer|Sunday|that|thing|time|today|Today|tomorrow|tonight|Tuesday|way|Wednesday|week|weekday|weekend|while|winter|year|yesterday)$/\tnone\t#1:func=/$1:tmod/
"""
