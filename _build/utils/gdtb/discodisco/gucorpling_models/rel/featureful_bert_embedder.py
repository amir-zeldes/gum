"""
This is a light modification of PretrainedTransformerEmbedder
"""
import logging
import math
...
@TokenEmbedder.register("featureful_bert")
class FeaturefulBertEmbedder(TokenEmbedder):
    """
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.transformer_model = FeaturefulBert.from_pretrained(model_name)
