...
MODEL_DIR=${2:-models}/${CORPUS}_rel_lm_transfer
...
allennlp train \
	configs/rel/e2e/transferlearning.jsonnet \
	-s "$MODEL_DIR" \
...
allennlp predict \
        ...
        --use-dataset-reader \
        --output-file tmp/predictions_e2e_rel_transfer_${CORPUS}.json
...
echo "#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
echo ""
python utils/e2e_metrics.py tmp/predictions_e2e_rel_transfer_${CORPUS}.json
