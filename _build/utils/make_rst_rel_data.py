...
def make_rels(rsd_data, conll_data, dev_set, test_set, corpus="eng.rst.gum", include_secedges=True, outmode="standoff"):
    if outmode == "standoff":
...
def main(conn_data, make_tok_files=True, reddit=False, corpus="gum", outmode="standoff"):
